    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="card">
                        <form method="POST" action="<?php echo base_url().'Dept/insert' ?>">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" required placeholder="Nama User" autofocus autocomplete="off" data-tooltip="tooltip" data-placement="top" title="Name">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Email</label>
                                    <input type="text" name="email" class="form-control" required placeholder="Email User" autocomplete="off" data-tooltip="tooltip" data-placement="top" title="Email">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Password</label>
                                    <input class="form-control" name="password" placeholder="Password" autocomplete="off" data-tooltip="tooltip" data-placement="top" title="Password"></input>
                                </div>
                                <div class="form-group">
